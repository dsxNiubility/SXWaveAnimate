...
- (void)viewDidLoad {
    ...
    self.animateView1.frame = CGRectMake(0, 64,SIDES, SIDES);
    [self.animateView1 setPrecent:self.precent description:@"汉字汉字" textColor:[UIColor redColor] bgColor:[UIColor darkGrayColor] alpha:0.5 endless:YES];
